...
set CLASSPATH=%APP_HOME%\lib\web.jar;%APP_HOME%\lib\services.jar;%APP_HOME%\lib\utils.jar;%APP_HOME%\lib\javax.servlet-api-3.0.1.jar

@rem Execute web
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %WEB_OPTS%  -classpath "%CLASSPATH%" com.builders.web %CMD_LINE_ARGS%
